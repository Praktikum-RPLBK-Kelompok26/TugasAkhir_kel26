...
import Modal_badan from "./Modal_badan";

const Scarlett_badan = () => {
    const pageTitle = 'Scarlett - Badan';
    const [scarlettm, setScarlettm] = useState([]);
    ...
    useEffect(() => {
        axios
            .get("scarlett_badan.json")
            .then((data) => {
                console.log(data.data);
                setScarlettm(data.data);
            })
            .catch((error) => {
                console.log(error);
            });
